...
class _$RefreshTokenResponseImpl implements _RefreshTokenResponse {
  ...
  @override
  String toString() {
    return 'RefreshTokenResponse(accessToken: $accessToken, refreshToken: $refreshToken, accessTokenExpiresIn: $accessTokenExpiresIn, accountStatus: $accountStatus)';
  }
...
abstract class _RefreshTokenResponse implements RefreshTokenResponse {
  const factory _RefreshTokenResponse(
      ...
      required final String? accountStatus}) = _$RefreshTokenResponseImpl;
